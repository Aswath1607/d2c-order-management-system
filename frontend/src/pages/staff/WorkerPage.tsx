...
export default function WorkerPage() {
  ...
  const update = async (id: number, action: 'accept' | 'complete') => {
    try { if (action === 'accept') await orderApi.acceptAssignment(id); else await orderApi.completeAssignment(id); await load(); }
